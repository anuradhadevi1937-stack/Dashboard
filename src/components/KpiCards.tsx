...
export const KpiCards: React.FC<KpiCardsProps> = ({ kpis, periodLabel }) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
      ...
      <div className="navy-card navy-card-hover p-6 relative overflow-hidden group">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="w-10 h-10 rounded-xl bg-indigo-500/15 text-indigo-400 flex items-center justify-center border border-indigo-500/30 group-hover:scale-110 transition-transform">
            <ShoppingBag size={20} />
          </div>
        </div>
      ...
      <div className="navy-card navy-card-hover p-6 relative overflow-hidden group border-orange-500/30">
        <div className="absolute top-0 right-0 w-32 h-32 bg-voyx-orange/15 rounded-full blur-2xl -mr-10 -mt-10 pointer-events-none" />
        
        <div className="flex items-center justify-between mb-4">
          <span className="text-xs font-bold uppercase tracking-wider text-orange-400">
            Net Revenue ({periodLabel})
          </span>
          <div className="w-10 h-10 rounded-xl bg-orange-500/15 text-voyx-orange flex items-center justify-center border border-orange-500/30 group-hover:scale-110 transition-transform">
            <IndianRupee size={20} />
          </div>
        </div>
      ...
      <div className="navy-card navy-card-hover p-6 relative overflow-hidden group">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="w-10 h-10 rounded-xl bg-cyan-500/15 text-cyan-400 flex items-center justify-center border border-cyan-500/30 group-hover:scale-110 transition-transform">
            <History size={20} />
          </div>
        </div>
